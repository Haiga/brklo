...
class DropoutRetrieverModel(LightningModule):
    """Encodes the text and label into a same space of embeddings."""

    def __init__(self, hparams):
        super(DropoutRetrieverModel, self).__init__()
    ...
    def training_step(self, batch, batch_idx):
        query_idx, passage_idx,  = batch["query_idx"], batch["passage"]
        query_rpr, passage_rpr = self(batch["query"], batch["passage_idx"])
